...
class AdventureGame{
    ...
    sleep = () => new Promise((r) => setTimeout(r, 1000));
...
function displayInstructions(adventureGame: AdventureGame): void {
    ...
    const boxedMessage = boxen(
        `${msg}\n\n${msg1}\n${msg2}`,
        { padding: 1, margin: 1, borderStyle: 'double', textAlignment: "center", borderColor: "blue" }
    );
    console.log(boxedMessage);
}

function displayPlayerAndEnemyHealth(playerHealth: number, enemy: string, enemyHealth: number): void {
    ...
    const boxedMessage = boxen(
        `${msg1}\n${msg2}\n${msg3}\n${msg4}\n${msg5}`,
        { padding: 1, margin: 1, borderStyle: 'double', textAlignment: "center", borderColor: "green" });
    console.log(boxedMessage);
}

async function attackEnemy(adventureGame: AdventureGame, enemy: string, enemyHealth: number): Promise<number> {
...
async function drinkHealthPotion(adventureGame: AdventureGame): Promise<void> {
...
async function runFromEnemy(enemy: string): Promise<void> {
...
async function startGame():Promise<void> {
    ...
    while (enemyAppeared){
        ...
        if (adventureGame.game.health === enemyHealth) {
            ...
            const boxedMessage = boxen(
                `${msg1}\n${msg2}\n${msg3}`, 
                { padding: 1, margin: 1 ,borderStyle:"classic", textAlignment:"center" ,borderColor:"grey"}
            );
            console.log(boxedMessage);
